...
class ClimateHelperTest {
    ...
    void latitudalLengthTest() {
        ...
        for (long yCoordinate = 1; yCoordinate <= world.getYSize(); yCoordinate++) {
            Climate startingSky = world.getCoordinate(1L, 1L).getClimate();
            Climate currentSky = startingSky;
            for (long xCoordinate = 1; xCoordinate <= world.getXSize(); xCoordinate++) {
                if (xCoordinate == 1) {
                    startingSky = world.getCoordinate(1L, yCoordinate).getClimate();
